...
EMAIL_HOST_PASSWORD = os.environ.get("PICKUP")
EMAIL_USE_SSL = True
...
LOGGING = {
    ...
    'formatters': {
        ...
        'warning_formatter': {
            'format': '%(asctime)s %(levelname)s %(pathname)-%(message)s'
        },
        'error_formatter': {
        ...
        'mail_formatter': {
            'format': '%(asctime)s %(levelname)s %(pathname)s-%(message)'
        },
